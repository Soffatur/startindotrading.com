...
@section('title', 'Detail Layanan Kami')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 ml-auto mb-2">
                <button class="btn btn-success" data-toggle="modal" data-target="#btnFormIdentityTelp"><i class="fa fa-plus"></i> Create Detail Our Service</button>
            </div>
            <div class="col-12">
                            ...
                            <table class="table m-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="15%">Detail Our Service</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">create Detail Our Service</h5>
            ...
            <div class="modal-body">
                <form action="" method="POST" id="finserttestimoni">
                    <div class="form-group">
                        ...
                        <select name="our_service" id="our_service" class="form-control">
                            <option value="">-- pilih --</option>
                            @foreach ($ourService as $row)
                                <option value="{{$row->id}}">{{$row->our_name_service}}</option>
                            @endforeach
                        </select>
                        <small class="text-danger" id="vu_our_service"></small>
                    </div>
                    <div class="form-group">
                        <label for="detail_our_service">Detail Our Service</label>
                        <textarea class="form-control" name="detail_our_service" placeholder="Input Our Service .."></textarea>
                        <small class="text-danger" id="vu_detail_our_service"></small>
                    </div>
...
<div class="modal fade" id="ubahtestimoni" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Detail Our Service</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="" method="POST" id="fupdatetestimoni">
                    <input type="hidden" name="id_detailOurService">
                    <div class="form-group">
                        <label for="our_service">Our Service</label>
                        <select name="our_service" id="our_service" class="form-control">
                            <option value="">-- pilih --</option>
                    ...
                    <div class="form-group">
                        <label for="detail_our_service">Detail Our Service</label>
                        <textarea class="form-control" name="detail_our_service" placeholder="Input Our Service .."></textarea>
                        <small class="text-danger" id="vc_detail_our_service"></small>
                    </div>
